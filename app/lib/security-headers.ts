export function getContentSecurityPolicy(isDev = false) {
  return [
    "default-src 'self'",
    isDev
...
export function getSecurityHeaders(isDev = false) {
  return [
    ...
    },
    {
      ...
      value:
        "camera=(), microphone=(), geolocation=(), usb=(), payment=(), accelerometer=(), gyroscope=(), magnetometer=(), browsing-topics=(), interest-cohort=()",
    },
    {
